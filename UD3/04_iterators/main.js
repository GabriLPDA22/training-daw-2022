...
//     // .filter((value) => value > 5)                // Filtrar ids mayores a 5
// }
...
// function avgYears(faction) {
//   let suma = pilots
//     .filter((value) => value.faction === faction)  // Filtra los pilotos de la facción dada
//     .map((v) => v.years)                           // Mapea los años de servicio de cada piloto
//     .reduce((pv, cv) => pv + cv, 0);               // Suma los años de servicio

//   return suma / pilots.filter((value) => value.faction === faction).length;  // Divide entre el número de pilotos de esa facción
// }
